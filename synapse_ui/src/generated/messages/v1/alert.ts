...
//   protoc               unknown
// source: messages/v1/alert.proto
...
export const AlertProto: MessageFns<AlertProto> = {
  encode(message: AlertProto, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<AlertProto>, I>>(object: I): AlertProto {
    const message = createBaseAlertProto();
