...
//   protoc               unknown
// source: settings/v1/color.proto
...
export const ColorConstraintProto: MessageFns<ColorConstraintProto> = {
  encode(message: ColorConstraintProto, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.format !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ColorConstraintProto {
  ...
  fromJSON(object: any): ColorConstraintProto {
    return {
      format: isSet(object.format) ? colorFormatProtoFromJSON(object.format) : 0,
      rangeMode: isSet(object.rangeMode) ? globalThis.Boolean(object.rangeMode) : false,
    };
  },
  ...
  create<I extends Exact<DeepPartial<ColorConstraintProto>, I>>(base?: I): ColorConstraintProto {
    return ColorConstraintProto.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ColorConstraintProto>, I>>(object: I): ColorConstraintProto {
    const message = createBaseColorConstraintProto();
