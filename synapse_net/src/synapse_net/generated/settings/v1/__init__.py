...
# sources: settings/v1/boolean.proto, settings/v1/color.proto, settings/v1/constraint_type.proto, settings/v1/enumerated.proto, settings/v1/file.proto, settings/v1/list.proto, settings/v1/number.proto, settings/v1/range.proto, settings/v1/settings.proto, settings/v1/string.proto, settings/v1/value.proto
...
@dataclass(eq=False, repr=False)
class FileConstraintProto(betterproto.Message):
    path: str = betterproto.string_field(1)
    file_types: List[str] = betterproto.string_field(2)
...
class ConstraintConfigProto(betterproto.Message):
    ...
    file: "FileConstraintProto" = betterproto.message_field(7, group="config")
    range: "RangeConstraintProto" = betterproto.message_field(8, group="config")
