...
# sources: settings/v1/boolean.proto, settings/v1/color.proto, settings/v1/constraint_type.proto, settings/v1/enumerated.proto, settings/v1/file.proto, settings/v1/list.proto, settings/v1/number.proto, settings/v1/settings.proto, settings/v1/string.proto, settings/v1/value.proto
