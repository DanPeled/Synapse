...
# sources: messages/v1/alert.proto, messages/v1/camera.proto, messages/v1/device.proto, messages/v1/log.proto, messages/v1/message.proto, messages/v1/pipeline.proto
...
from ...settings import v1 as __settings_v1__
...
class CameraProto(betterproto.Message):
    ...
    settings: List["__settings_v1__.SettingMetaProto"] = betterproto.message_field(8)
...
class PipelineTypeProto(betterproto.Message):
    ...
    settings: List["__settings_v1__.SettingMetaProto"] = betterproto.message_field(2)
...
class PipelineProto(betterproto.Message):
    ...
    settings_values: Dict[str, "__settings_v1__.SettingValueProto"] = (
...
class SetPipleineSettingMessageProto(betterproto.Message):
    ...
    value: "__settings_v1__.SettingValueProto" = betterproto.message_field(2)
...
class PipelineResultProto(betterproto.Message):
    ...
    value: "__settings_v1__.SettingValueProto" = betterproto.message_field(4)
