...
/**
 * Represents a single detected AprilTag along with its associated metadata and
 * pose estimates.
 *
 * <p>
 * This class contains the tag's ID, detection accuracy metrics, and the
 * estimated poses of the
 * camera and tag in multiple coordinate systems. It is typically produced by an
 * AprilTag detection
 * pipeline.
 */
public class SynapseApriltagDetection {

  /**
   * The unique ID of the detected AprilTag.
   *
   * <p>
   * Serialized/deserialized as {@code "tag_id"} in JSON.
   */
  @JsonProperty("tag_id")
  public int tagID;

  /**
   * The Hamming distance of the detected tag, representing the number of bit
   * errors.
   *
   * <p>
   ...
   *
   * <p>
   * Format: {@code [x, y, z, roll, pitch, yaw]}.
   */
   ...
   *
   * <p>
   * This constructor is primarily used for JSON deserialization by Jackson and
   * for general
   * instantiation when no initial values are provided.
   */
  public SynapseApriltagDetection() {
  }
   ...
   *
   * <p>
   * Two {@code ApriltagDetection} objects are considered equal if all of the
   * following are true:
   *
   * <ul>
   * <li>Their {@link #tagID} values are the same.
   * <li>Their {@link #hamming} values are numerically equal.
   * <li>Their {@link #cameraPose_fieldSpace}, {@link #cameraPose_tagSpace}, and
   * {@link
  ...
  public boolean equals(Object o) {
    if (this == o)
      return true;
    if (!(o instanceof SynapseApriltagDetection))
      return false;
    SynapseApriltagDetection that = (SynapseApriltagDetection) o;
   ...
   *
   * <p>
   * The hash code is based on the same fields used in {@link #equals(Object)}:
   * {@link #tagID},
   * {@link #hamming}, {@link #cameraPose_fieldSpace},
   * {@link #cameraPose_tagSpace}, {@link
